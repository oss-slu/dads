...
def data2():
    ...
    data = connector.getSystem(target['label'])
    return jsonify(data)
...
# example call json data that would return 
#    systems with degree of 2 and 3, dimension = 4: {'degree': [2,3], 'N': [4]}
...
# expects json describing filters,
# returns stats on the systems that satisfy those filters in an array
